        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-4">
                            <p><strong>Semester:</strong> {{ $legger->semester->nama }}
                                ({{ $legger->semester->tahunAkademik->tahun }})</p>
                            <p><strong>Wali Kelas:</strong> {{ $legger->kelas->waliKelas->nama_lengkap ?? '-' }}</p>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <p><small>* Kode Mapel:</small><br>
                                @foreach ($subjects as $mps)
                                    <small><strong>{{ $mps->mataPelajaran->kode }}</strong>:
                                        {{ $mps->mataPelajaran->nama }} | </small>
                                @endforeach
                            </p>
                        </div>
                    </div>
