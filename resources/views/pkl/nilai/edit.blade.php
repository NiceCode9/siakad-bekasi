                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <div class="card-title mb-4">
                            <h5 class="mb-1 font-weight-bold">Input Nilai PKL: {{ $pkl->siswa->nama }}</h5>
                        ...
                        <form action="{{ route('pkl-nilai.update', $pkl->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group text-center">
                                        ...
                                        <input type="number" step="0.01" name="nilai_sikap_kerja" id="sikap"
                                            class="form-control calc-trigger text-center h4"
                                            value="{{ old('nilai_sikap_kerja', $nilai->nilai_sikap_kerja) }}" required
                                            min="0" max="100">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group text-center">
                                        ...
                                        <input type="number" step="0.01" name="nilai_keterampilan" id="keterampilan"
                                            class="form-control calc-trigger text-center h4"
                                            value="{{ old('nilai_keterampilan', $nilai->nilai_keterampilan) }}" required
                                            min="0" max="100">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group text-center">
                                        ...
                                        <input type="number" step="0.01" name="nilai_laporan" id="laporan"
                                            class="form-control calc-trigger text-center h4"
                                            value="{{ old('nilai_laporan', $nilai->nilai_laporan) }}" required
                                            min="0" max="100">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group text-center">
                                        ...
                                        <input type="number" step="0.01" name="nilai_dari_sekolah" id="sekolah"
                                            class="form-control calc-trigger text-center h4"
                                            value="{{ old('nilai_dari_sekolah', $nilai->nilai_dari_sekolah) }}" required
                                            min="0" max="100">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_penilaian" class="form-control"
                                    value="{{ old('tanggal_penilaian', $nilai->tanggal_penilaian ? $nilai->tanggal_penilaian->format('Y-m-d') : date('Y-m-d')) }}"
                                    required>
                            </div>
