    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="mb-3 card-title font-weight-bold">Edit Data Industri / Tempat PKL</h5>
                        <form action="{{ route('perusahaan-pkl.update', $perusahaanPkl->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama"
                                    ...
                                    value="{{ old('nama', $perusahaanPkl->nama) }}" required>
                                @error('nama')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="bidang_usaha" class="form-control"
                                    value="{{ old('bidang_usaha', $perusahaanPkl->bidang_usaha) }}">
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telepon" class="form-control"
                                            value="{{ old('telepon', $perusahaanPkl->telepon) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_kontak" class="form-control"
                                            value="{{ old('nama_kontak', $perusahaanPkl->nama_kontak) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jabatan_kontak" class="form-control"
                                            value="{{ old('jabatan_kontak', $perusahaanPkl->jabatan_kontak) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            value="{{ old('email', $perusahaanPkl->email) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="kuota" class="form-control"
                                    value="{{ old('kuota', $perusahaanPkl->kuota) }}" min="0">
                            </div>

                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="is_active" name="is_active"
                                        value="1" {{ $perusahaanPkl->is_active ? 'checked' : '' }}>
