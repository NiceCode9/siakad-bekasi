                                    ...
                                    @foreach ($raport->raportDetail as $detail)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <strong>{{ number_format($detail->nilai_akhir, 0) }}</strong>
                                            </td>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    @forelse($nilaiEkskul as $ekskul)
                                        <p><strong>{{ $ekskul->ekstrakurikuler->nama }}:</strong> {{ $ekskul->nilai }}
                                            ({{ $ekskul->predikat }})
                                        </p>
                                    @empty
